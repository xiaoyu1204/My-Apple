...
public interface IMeLogin {
    ...
    interface View extends IBaseView {
        //定义一个被实现的View层接口方法
        void getMeLoginReturn(MeLoginBean result);
    }

    interface Persenter extends IBasePersenter<View> {
        //定义一个V层调用的接口
        void getMeLogin(String username,String password);
    }

    interface Model extends IBaseModel {
        //定义一个加载数据的接口方法   被P层
        void getMeLogin(String username,String password, Callback callback);
    }
