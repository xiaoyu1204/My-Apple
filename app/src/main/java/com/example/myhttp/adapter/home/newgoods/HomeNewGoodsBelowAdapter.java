...
public class HomeNewGoodsBelowAdapter extends BaseAdapter {

    public HomeNewGoodsBelowAdapter(Context context, List Data) {
        super(context, Data);
    }
    ...
    protected void bindData(Object data, VH vh) {
        ...
        Home_NewGoods_Below_Bean.DataBeanX.DataBean dataBean = (Home_NewGoods_Below_Bean.DataBeanX.DataBean) data;
